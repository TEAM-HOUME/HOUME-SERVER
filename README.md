  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>
          <img 
            src="https://github.com/bontak.png" 
            alt="구본탁" 
            style="width: 360px;"
          />
        </td>
      ...
      <tr align="center">
        <td>
          <a href="https://github.com/gdbs1107" target="_blank">@maehwasoo</a>
        </td>
        <td>
          <a href="https://github.com/PBEM22" target="_blank">@soyyyyy</a>
        </td>
        <td>
          <a href="https://github.com/bontak" target="_blank">@jstar000</a>
        </td>
      </tr>
    </tbody>
  </table>
