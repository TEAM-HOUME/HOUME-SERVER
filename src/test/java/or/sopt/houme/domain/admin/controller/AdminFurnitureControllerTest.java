...
class AdminFurnitureControllerTest {
    ...
    @Test
    @DisplayName("POST /api/v1/admin/furniture/prompt 요청으로 가구 프롬프트를 등록할 수 있다")
    ...
    void getFurnitures_success() throws Exception {
        // given
        AdminFurnitureGetDTO.TagInfo tagInfo = new AdminFurnitureGetDTO.TagInfo(1L, "모던");
    ...
    @Test
    @DisplayName("PATCH /api/v1/admin/furniture 요청으로 가구 정보를 수정할 수 있다")
    void updateFurniture_success() throws Exception {
        ...
        mockMvc.perform(patch("/api/v1/admin/furniture")
                ...
                .andExpect(jsonPath("$.code").value(200))
                .andExpect(jsonPath("$.msg").value("응답 성공"))
                .andExpect(jsonPath("$.data").value("업데이트가 성공적으로 완료되었습니다"));
    }
