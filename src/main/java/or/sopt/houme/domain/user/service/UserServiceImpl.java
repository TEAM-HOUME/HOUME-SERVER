...
public class UserServiceImpl implements UserService {
    ...
    public ImageHistoryResultPageResponse getImageHistoryResultPage(User user, Long imageId) {
        ...
        PromptPreference topByHouseIdOrderByIdDesc = promptPreferenceRepository.findTopByHouseIdOrderByIdDesc(house.getId());

        return ImageHistoryResultPageResponse.of(house.getEquilibrium().getDescription(), house.getForm().toString(), tag.getTagNameKr(), findUser.getName(), generateImage.getUrl(), topByHouseIdOrderByIdDesc.getPreference().isLike());
    }
